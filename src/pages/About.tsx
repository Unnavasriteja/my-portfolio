  ...
  const timeline = [
    {
      ...
      description:
        'Worked on freelance projects focusing on cloud automation, CI/CD, container orchestration, and infrastructure reliability across AWS, GCP, and Azure.',
      icon: Code,
    },
    {
      year: '2021 – 2023',
      title: 'MSc Cloud Computing',
      company: 'University of Leicester, United Kingdom',
      description:
        'Master’s degree focused on cloud architecture, distributed systems, virtualization, and DevOps methodologies.',
      icon: MapPin,
    },
    {
      year: 'Nov 2017 – Dec 2020',
      title: 'Sr. Systems Engineer (Cloud Application Operations)',
    ...
    
    {
      ...
      company: 'SCSVMV University, Chennai, India',
      description:
        'Bachelor’s degree with emphasis on software engineering, networks, and foundational computer science.',
      icon: MapPin,
    },
  ];
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-neutral-400 max-w-2xl mx-auto">
              My journey as a DevOps and cloud engineer
            </p>
          </motion.div>
